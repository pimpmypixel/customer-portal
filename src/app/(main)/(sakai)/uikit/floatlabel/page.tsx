                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <Calendar
                            inputId="calendar"
                            value={value5}
                            onChange={e => setValue5(e.value ?? '')}></Calendar>
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <Chips
                            inputId="chips"
                            value={value6}
                            onChange={e => setValue6(e.value ?? [])}></Chips>
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputMask
                            ...
                            mask="99/99/9999"
                            value={value7}
                            onChange={e => setValue7(e.value ?? '')}></InputMask>
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputNumber
                            id="inputnumber"
                            value={value8}
                            onValueChange={e => setValue8(e.target.value ?? null)}></InputNumber>
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputTextarea
                            ...
                            rows={3}
                            value={value12}
                            onChange={e => setValue12(e.target.value)}></InputTextarea>
